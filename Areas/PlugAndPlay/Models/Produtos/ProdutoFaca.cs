...
{
    [Display(Name = "FACAS")]
    public class ProdutoFaca : ProdutoAbstrato
    {
        public ProdutoFaca()
        {
            Indisponibilidade = new HashSet<V_DISPONIBILIDADE_FACA>();
        }
        ...
        public virtual ICollection<V_DISPONIBILIDADE_FACA> Indisponibilidade { get; set; }
    }
}
