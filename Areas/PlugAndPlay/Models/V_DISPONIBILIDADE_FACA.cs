...
{
    [Display(Name = "DISPONIBILIDADE DE FACA")]

    public class V_DISPONIBILIDADE_FACA
    {
        ...
        public virtual ProdutoFaca ProdutoFaca { get; set; }
        ...
        public bool BeforeChanges(List<object> objects, ref CloneObjeto cloneObjeto, List<LogPlay> Logs, ref int modo_insert)
        {
            ...
            {
                V_DISPONIBILIDADE_FACA disp_faca = (V_DISPONIBILIDADE_FACA)item;
                if (disp_faca.PlayAction.ToUpper() == "UPDATE" || disp_faca.PlayAction.ToUpper() == "INSERT")
                {
