...
{
    public class ViewPedidosFuturosPIMap : IEntityTypeConfiguration<ViewPedidosFuturosPI>
    {
        public void Configure(EntityTypeBuilder<ViewPedidosFuturosPI> builder)
        {
            builder.ToTable("V_PEDIDOS_FUTUROS_PI");
