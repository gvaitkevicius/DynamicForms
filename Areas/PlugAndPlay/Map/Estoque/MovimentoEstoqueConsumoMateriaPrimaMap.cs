...
{
    public class MovimentoEstoqueConsumoMateriaPrimaMap : IEntityTypeConfiguration<MovimentoEstoqueConsumoMateriaPrima>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<MovimentoEstoqueConsumoMateriaPrima> builder)
        {
            ...
            builder.HasOne(me => me.OcorrenciaProducaoParciais).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.MOV_OCO_ID_OP_PARCIAL);
            builder.HasOne(me => me.OcorrenciaConsumoMateriaPrima).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.OCO_ID);
            builder.HasOne(me => me.TipoMovSaidaConsumo).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.TIP_ID);
            builder.HasOne(me => me.Produto).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.PRO_ID);
            builder.HasOne(me => me.Carga).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.CAR_ID);
            builder.HasOne(me => me.Turno).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.TURN_ID);
            builder.HasOne(me => me.Turma).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.TURM_ID);
            builder.HasOne(me => me.Usuario).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.USE_ID);
            builder.HasOne(me => me.Order).WithMany(u => u.MovimentoEstoqueConsumoMateriaPrima).HasForeignKey(me => me.ORD_ID);
        }
    }
}
