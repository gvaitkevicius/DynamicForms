...
{
    public class MovimentoEstoquePerdasMap : IEntityTypeConfiguration<MovimentoEstoquePerdas>
    {
        public void Configure(EntityTypeBuilder<MovimentoEstoquePerdas> builder)
        {
            ...
            builder.HasOne(me => me.OcorrenciaMotivosDasPerdas).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.OCO_ID);
            builder.HasOne(me => me.OcorrenciaProducaoParciais).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.MOV_OCO_ID_OP_PARCIAL);
            builder.HasOne(me => me.TipoMovSaidaPerdas).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.TIP_ID);
            builder.HasOne(me => me.Carga).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.CAR_ID);
            builder.HasOne(me => me.Turno).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.TURN_ID);
            builder.HasOne(me => me.Turma).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.TURM_ID);
            builder.HasOne(me => me.Usuario).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.USE_ID);
            builder.HasOne(me => me.Order).WithMany(u => u.MovimentoEstoquePerdas).HasForeignKey(me => me.ORD_ID);
        }
    }
}
